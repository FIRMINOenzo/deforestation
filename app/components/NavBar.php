...
function Navbar() {
    return "<nav class='navbar navbar-expand-lg navbar-light bg-light'>
        <div class='container'>
            <a class='navbar-brand' href='/deforestation/app/views' id='title'>Deforestation</a>
            ...
            <div class='collapse navbar-collapse' id='navbarNav'>
                <ul class='navbar-nav ml-auto'>
                    ...
                    <li class='nav-item active'>
                        <a class='nav-link' id='home-link' href='/deforestation/app/views'>Home <span class='sr-only'>(current)</span></a>
                    </li>
                    <li class='nav-item'>
                        <a class='nav-link' href='/deforestation/app/views/authors.php' id='authors-link'>Autores</a>
                    </li>
                    <li class='nav-item'>
                        <div class='dropdown'>
